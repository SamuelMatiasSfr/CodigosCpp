...
- Praticar estrutura de árvore de pesquisa binária
- Implementar inserção, busca e remoção de nós
- Comparar comportamento com conjuntos distintos de dados

## Funcionalidades

- Inicializar estrutura de árvore
